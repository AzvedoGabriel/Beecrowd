package br.com.beecrowd.media.nota.quatro;

import java.text.DecimalFormat;
import java.util.Locale;
import java.util.Scanner;

public class MediaAlunoNota {
    private static final Scanner scan = new Scanner(System.in).useLocale(Locale.US);
    private static double PESO_MEDIA_UM = 2;
    private static double PESO_MEDIA_DOIS = 3;
    private static double PESO_MEDIA_TRES = 4;
    private static double PESO_MEDIA_QUATRO = 1;
    private static double DIVISAO_PARA_RECALCULO_MEDIA = 2;
    private static double PESO_NOTAS_TOTAL = 10;
